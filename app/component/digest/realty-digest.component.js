        ...
        execute: function() {
            RealtyDigestComponent = (function () {
                function RealtyDigestComponent(_hubService) {
                    ...
                    this.PHOTO_STORAGE_URL = 'http://localhost:4567/photo_storage/';
                    this.compact = false;
                }
                ;
