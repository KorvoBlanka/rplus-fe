...
var TabListOfferComponent = (function () {
    ...
    TabListOfferComponent.prototype.ngOnInit = function () {
        ...
        this.page = 0;
        this._offerService.list(this.page, 32, {}, "", []).subscribe(function (data) {
            _this.offers = data;
    ...
    TabListOfferComponent.prototype.toggleDraw = function () {
        ...
        if (!this.mapDrawAllowed) {
            this.searchArea = [];
            this._offerService.list(this.page, 32, {}, "", this.searchArea).subscribe(function (data) {
                _this.offers = data;
            }, function (err) { return console.log(err); });
        }
    };
    ...
    TabListOfferComponent.prototype.searchParamChanged = function (e) {
        var _this = this;
        this.page = 0;
        this._offerService.list(this.page, 32, this.filter, this.searchQuery, this.searchArea).subscribe(function (data) {
            _this.offers = data;
        }, function (err) { return console.log(err); });
    };
    ...
    TabListOfferComponent.prototype.getOfferDigest = function (o) {
        return offer_1.Offer.getDigest(o);
    };
