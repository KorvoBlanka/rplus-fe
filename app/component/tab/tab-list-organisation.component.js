System.register(['angular2/core', '../../service/config.service', '../../service/organisation.service', '../ui/ui-select.component', '../digest/organisation-digest.component'], function(exports_1) {
        ...
        execute: function() {
            TabListOrganisationComponent = (function () {
                function TabListOrganisationComponent(_configService, _organisationService) {
                    ...
                    setTimeout(function () { _this.tab.header = 'organisation list'; });
                }
