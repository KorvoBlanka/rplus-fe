System.register(['angular2/core', '../../service/realty.service', '../../service/config.service', '../../class/realty', '../ui/ui-select.component', '../digest/realty-digest.component', '../realty-table.component', '../google-map.component'], function(exports_1, context_1) {
    "use strict";
            ...
            TabListRealtyComponent = (function () {
                ...
                TabListRealtyComponent.prototype.scroll = function (e) {
                    ...
                    if (e.currentTarget.scrollTop + e.currentTarget.clientHeight >= e.currentTarget.scrollHeight) {
                        this._realtyService.getRealty(this.page, 10, JSON.stringify(this.filter), this.searchQuery).then(function (realty) {
                ...
                TabListRealtyComponent.prototype.searchParamChanged = function (e) {
                    var _this = this;
                    this.page = 0;
                    this._realtyService.getRealty(this.page, 10, JSON.stringify(this.filter), this.searchQuery).then(function (realty) {
                        _this.realtys = realty;
