System.register(['angular2/core', '../../service/config.service', '../../service/request.service', '../ui/ui-select.component', '../digest/request-digest.component'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            TabListRequestComponent = (function () {
                function TabListRequestComponent(_configService, _requerstService) {
                    ...
                    this.page = 0;
                    this.perPage = 32;
                    this._requerstService.list(this.page, this.perPage, "", "").then(function (requests) {
                ...
                TabListRequestComponent.prototype.searchParamChanged = function () {
                    var _this = this;
                    this.page = 0;
                    this._requerstService.list(this.page, this.perPage, "", this.searchQuery).then(function (requests) {
                        _this.requests = requests;
                        _this.page++;
                    });
                };
