...
var TabListRequestComponent = (function () {
    ...
    TabListRequestComponent.prototype.toggleSource = function (s) {
        if (s == 'local') {
...
TabListRequestComponent = __decorate([
    ...
    __metadata("design:paramtypes", [config_service_1.ConfigService, hub_service_1.HubService, request_service_1.RequestService, user_service_1.UserService])
