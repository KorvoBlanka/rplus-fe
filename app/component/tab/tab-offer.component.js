...
var TabOfferComponent = (function () {
    function TabOfferComponent(_hubService, _configService, _offerService, _requestService, _taskService, _analysisService, _historyService, _photoService, _userService) {
        var _this = this;
    ...
    TabOfferComponent.prototype.ngOnInit = function () {
        ...
        */
        if (this.offer.agentId != null) {
            this._userService.get(this.offer.agentId).then(function (agent) {
                _this.agent = agent;
            });
        }
        this.calcSize();
    };
    TabOfferComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        setTimeout(function () {
    ...
    TabOfferComponent.prototype.save = function () {
        var _this = this;
        this._offerService.saveOffer(this.offer).then(function (offer) {
            console.log(offer);
            _this.toggleEdit();
        });
    };
    ...
    TabOfferComponent.prototype.markerClick = function (r) {
        console.log('markerClick');
        console.log(r);
        //r.selected = !r.selected;
        // scroll to object ???
    };
    TabOfferComponent.prototype.getOfferDigest = function (r) {
