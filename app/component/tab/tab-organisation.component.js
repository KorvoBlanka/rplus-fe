System.register(['angular2/core', '../../pipe/format-date.pipe', '../../service/analysis.service', '../../class/realty', '../../class/person', '../../service/hub.service', '../../service/config.service', '../../service/organisation.service', '../../service/task.service', '../../service/history.service', '../../service/realty.service', '../../service/person.service', '../ui/ui-select.component', '../ui/ui-carousel.component', '../ui/ui-tag-block.component', '../ui/ui-tabs.component', '../ui/ui-tab.component', '../ui/ui-pie-chart.component', '../ui/ui-line-chart.component', '../ui/ui-bar-chart.component', '../digest/history-digest.component', '../digest/realty-digest.component', '../digest/person-digest.component', '../google-map.component'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            TabOrganisationComponent = (function () {
                function TabOrganisationComponent(_hubService, _configService, _realtyService, _taskService, _analysisService, _historyService, _personService, _organisationService) {
                    var _this = this;
                ...
                TabOrganisationComponent.prototype.save = function () {
                    var _this = this;
                    if (this.organisation.id == null) {
                        this._organisationService.create(this.organisation).then(function (org) {
                            _this.organisation = org;
                        });
                    }
                    else {
                        this._organisationService.update(this.organisation).then(function (org) {
                            _this.organisation = org;
                        });
                        ;
                    }
                ...
                TabOrganisationComponent.prototype.getPersons = function (page, per_page) {
                    var _this = this;
                    this._personService.list(page, per_page, this.organisation.id, "").then(function (persons) {
                ...
                TabOrganisationComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [hub_service_1.HubService, config_service_1.ConfigService, realty_service_1.RealtyService, task_service_1.TaskService, analysis_service_1.AnalysisService, history_service_1.HistoryService, person_service_1.PersonService, organisation_service_1.OrganisationService])
