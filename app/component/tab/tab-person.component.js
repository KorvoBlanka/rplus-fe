...
var TabPersonComponent = (function () {
    ...
    TabPersonComponent.prototype.offersSelected = function () {
        var _this = this;
        this._offerService.list(0, 32, { personId: this.person.id }, "", []).subscribe(function (offers) {
            _this.offers = offers;
        });
    };
    TabPersonComponent.prototype.requestsSelected = function () {
        var _this = this;
        this._requestService.list(0, 32, null, this.person.id, "").subscribe(function (requests) {
