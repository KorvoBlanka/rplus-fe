System.register(['angular2/core', '../../pipe/format-date.pipe', '../../service/analysis.service', '../../class/user', '../../class/realty', '../../class/organisation', '../../class/request', '../../service/hub.service', '../../service/config.service', '../../service/realty.service', '../../service/request.service', '../../service/task.service', '../../service/history.service', '../../service/person.service', '../../service/organisation.service', '../../service/settings/user.service', '../ui/ui-select.component', '../ui/ui-carousel.component', '../ui/ui-tag-block.component', '../ui/ui-tabs.component', '../ui/ui-tab.component', '../ui/ui-pie-chart.component', '../ui/ui-line-chart.component', '../ui/ui-bar-chart.component', '../digest/realty-digest.component', '../digest/request-digest.component', '../digest/history-digest.component', '../google-map.component'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            TabPersonComponent = (function () {
                function TabPersonComponent(_hubService, _configService, _realtyService, _requestService, _taskService, _analysisService, _historyService, _personService, _organisationService, _userService) {
                    var _this = this;
                    ...
                    this.ch3_data = [];
                    this.ch4_data = [];
                    _organisationService.list(0, 100, "").then(function (orgs) {
                        for (var i = 0; i < orgs.length; i++) {
                            var o = orgs[i];
                            _this.organisations_opts.push({
                                val: o.id,
                                label: o.name
                            });
                        }
                    });
                    _userService.list("agent", "").then(function (agents) {
                ...
                TabPersonComponent.prototype._wrapArray = function (a) {
                    var r = [];
                ...
                TabPersonComponent.prototype._unwrapArray = function (a) {
                    var r = [];
                ...
                TabPersonComponent.prototype.save = function () {
                    ...
                    if (this.person.id == null) {
                        this._personService.create(this.person).then(function (person) {
                            _this.person = person;
                            _this.toggleEdit();
                        });
                    }
                    else {
                        this._personService.update(this.person).then(function (person) {
                            _this.person = person;
                            _this.toggleEdit();
                        });
                    }
