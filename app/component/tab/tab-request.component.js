...
var TabRequestComponent = (function () {
    ...
    TabRequestComponent.prototype.ngOnInit = function () {
        ...
        this._offerService.list(0, 32, {}, this.request.request, []).subscribe(function (data) {
            _this.offers = data;
    ...
    TabRequestComponent.prototype.getOffers = function (page, per_page) {
        var _this = this;
        this._offerService.list(page, per_page, {}, this.queryText, this.searchArea).subscribe(function (data) {
            _this.offers = data;
        }, function (err) { return console.log(err); });
    };
