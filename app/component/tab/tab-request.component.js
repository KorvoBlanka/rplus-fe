...
var TabRequestComponent = (function () {
    ...
    TabRequestComponent.prototype.ngOnInit = function () {
        ...
        this._offerService.list(0, 32, offer_service_1.OfferSource.LOCAL, { offerTypeCode: this.request.offerTypeCode }, this.request.request, this.request.searchArea).subscribe(function (data) {
            _this.offers = data;
