System.register(['angular2/core', '../../pipe/format-date.pipe', '../../service/analysis.service', '../../class/realty', '../../service/hub.service', '../../service/config.service', '../../service/realty.service', '../../service/request.service', '../../service/task.service', '../../service/history.service', '../../service/person.service', '../ui/ui-select.component', '../ui/ui-carousel.component', '../ui/ui-tag-block.component', '../ui/ui-tabs.component', '../ui/ui-tab.component', '../ui/ui-pie-chart.component', '../ui/ui-line-chart.component', '../ui/ui-bar-chart.component', '../digest/realty-digest.component', '../digest/request-digest.component', '../digest/history-digest.component', '../google-map.component'], function(exports_1) {
        ...
        execute: function() {
            TabRequestComponent = (function () {
                function TabRequestComponent(_hubService, _configService, _realtyService, _requestService, _taskService, _analysisService, _historyService, _personService) {
                    ...
                    this.ch3_data = [];
                    this.ch4_data = [];
                    setTimeout(function () { _this.tab.header = 'request ' + _this.person.id; });
                }
                ...
                TabRequestComponent.prototype.addPhone = function () {
                    this.person.phone.push({ s: '' });
                };
                TabRequestComponent.prototype.addEmail = function () {
