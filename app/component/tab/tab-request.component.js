...
var TabRequestComponent = (function () {
    ...
    TabRequestComponent.prototype.ngOnInit = function () {
        ...
        this._personService.get(this.request.personId).then(function (person) {
            _this.person = person;
        });
        if (this.request.agentId != null) {
            this._userService.get(this.request.agentId).then(function (agent) {
                _this.agent = agent;
            });
        }
        this.calcSize();
    ...
    TabRequestComponent.prototype.save = function () {
        var _this = this;
        this._requestService.save(this.request).then(function (request) {
